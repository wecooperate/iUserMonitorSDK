...
:GenerateSolution
cmake -G "Visual Studio 17 2022" -A "x64" -T "v141" sample/CMakeLists.txt -B build/64
cmake -G "Visual Studio 17 2022" -A "Win32" -T "v141" sample/CMakeLists.txt -B build/32
Goto Menu
